...
#########
# Mode interactif: Se declenche s'il manque un argument essentiel pour la migration 
#########
    ...
    """)
                    ...
                    if choix=="1":
                        choisir_ou_creer_cles(db) # Choisir ou créer des clés dans la collection "cles" afin de faciliter l’ajout de documents dans la collection cible.
                    elif choix=="2":
                        ...
                        nettoyer_et_migrer_csv(db, collection, csv_file,args.pas_vider_col)  #Lance la fonction de migration du fichier CSV avec un nettoyage préalable
                    elif choix=="4":
                        break
                    else:
